...
int main()
{
    ...
    // y = x%10;       Problem 08
    // y = x/100;      Problem 09
    // y = (x/10)%10;  Problem 10
    /*printf("Enter a Two-digit Number: ");
    scanf("%d",&x);*/
    // y = ((x%10)+(x/10));      Problem 11
    /*printf("Enter a Three-digit Number: ");
    scanf("%d",&x);*/
    // y = ((x%10)+(x/100)+((x/10)%10));  Problem 12
    /*printf("Enter a Two-digit Number: ");
    scanf("%d",&x);*/
    // y = ((x%10)*10)+(x/10);  Problem 13
    /*printf("Enter a Three-digit Number: ");
    scanf("%d",&x);
    y = ((x%10)*100)+(((x/10)%10)*10)+(x/100); Problem 14*/
    /*printf("Enter a Four-digit Number: ");
    scanf("%d",&x);*/
    // y = ((x/100)*100)+((x%10)*10)+((x%100)/10);      Problem 15
    // y = (((x/100)%10)*1000)+((x/1000)*100)+(x%100);  Problem 16
    /*printf("Enter a Two-digit Number: ");
    scanf("%d",&x);*/
    // y = ((x/10)*10);       Problem 17
    // y = 10+(x%10);         Problem 18
    /*printf("Enter a Three-digit Number: ");
    scanf("%d",&x);*/
    // y  = ((x/10)*10)+2;           Problem 19
    // y = ((x/100)*100)+(x%10);     Problem 20
    /*printf("Enter a Number: ");
    scanf("%d",&x);*/
    // y = x - 5*(x%2);              Problem 21
    // y = x - 5*(((x/10)%10)%2);    Problem 22
    /*printf("Enter a Two-digit Number: ");
    scanf("%d",&x);
    y  =  x - 5*(((x/10)+(x%10))%2);    Problem 23*/
    printf("Enter a Three-digit Number: ");
    scanf("%d", &x);
    // y = x - 5*(((x/100)%2)*((x%10)%2));   Problem 24
    int s = (x % 10) + (x / 100) + ((x / 10) % 10);
    y = (s * (1 - (s / 10))) + ((s / 10) * ((s / 10) + (s % 10)));
    y = (y / 10) + (y % 10); // Problem 25
    printf("Result = %d", y);
}