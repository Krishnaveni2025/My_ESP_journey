...
*ptr1: 10
**ptr2: 10
Explanation: In this code, ptr1 is a pointer that stores the address of the integer variable var. 
  ptr2 is a double pointer that stores the address of the pointer ptr1. **ptr2 dereferences ptr2 to get the value of ptr1 (which is the address of var) and 
then dereferences that address to get the value of var itself.
...
In other words, we can say that to change the value of a " level - x " variable we can use a " level - x+1 " pointer. 
